...
function ProfileHeader() {
  ...
  return (
    <>
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              className={`p-2 rounded-full transition-all ${
                isSoundEnabled ? "text-cyan-400 bg-cyan-500/20" : "text-white/40 hover:bg-white/10"
              }`}
            >
      ...
      {/* SETTINGS SIDEBAR - Glassmorphic Slide out from right */}
      {isSettingsOpen && (
        <>
          {/* Backdrop */}
          <div 
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-5 border-b border-white/10 bg-white/5">
              <div>
                <h2 className="text-xl font-bold text-gray-400 bg-clip-text text-transparent">
                  Profile Settings
                </h2>
                <p className="text-sm text-white/40 mt-0.5">Update your personal information</p>
              </div>
              <button 
                onClick={() => setIsSettingsOpen(false)} 
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar">
              ...
              <div className="flex flex-col items-center py-10">
                <div className="relative group">
                  ...
                  <button 
                    ...
                    className="absolute bottom-1 right-1 p-2.5 rounded-full bg-gradient-to-r from-cyan-500 to-cyan-600 text-black shadow-lg hover:scale-110 transition-transform duration-300"
                  >
                    <Camera size="16" />
                  </button>
                ...
                {isUpdatingProfile && (
                  <div className="mt-3 text-xs text-cyan-400 animate-pulse">Uploading...</div>
                )}
              </div>
              ...
              <div className="px-6 space-y-6 pb-10">
                <div>
                  ...
                  <div className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-xl px-4 py-3 focus-within:border-cyan-500 transition-all duration-300">
                    <input
                      type="text"
                ...
                <button
                  ...
                  disabled={isUpdatingProfile}
                  className="w-full py-3.5 bg-gradient-to-r from-cyan-500 to-cyan-600 hover:from-cyan-400 hover:to-cyan-500 disabled:from-gray-600 disabled:to-gray-600 text-black font-bold rounded-xl transition-all duration-300 shadow-lg shadow-cyan-500/25 hover:shadow-cyan-500/40 hover:scale-[1.02] active:scale-[0.98]"
                >
                ...
                <div className="pt-4">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 py-3 bg-red-500/10 hover:bg-red-500/20 text-red-400 rounded-xl border border-red-500/20 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]"
                  >
                    <LogOutIcon size="16" />
      ...
      {showLogoutConfirm && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/60 backdrop-blur-md animate-in fade-in duration-200">
          <div className="bg-black/60 backdrop-blur-xl border border-white/20 rounded-2xl max-w-sm w-full mx-4 p-6 animate-in zoom-in-95 duration-200 shadow-2xl">
            ...
            <p className="text-white/50 mt-2 text-sm">You will be logged out of your account.</p>
